 ...
 */
static const uint8_t Sha256NullStringDigest[] =
{
...
{
    uint8_t Hash[NVBOOT_SHA256_LENGTH_BYTES];
} NvBootSha256HashDigest __attribute__((aligned(NVBOOT_CRYPTO_BUFFER_ALIGNMENT)));
